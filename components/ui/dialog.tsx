...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        `fixed left-[50%] top-[50%] z-50 grid w-full xxxs:max-w-[300px] xxs:max-w-[340px] sm:max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-neutral-800 bg-white dark:bg-neutral-950 
