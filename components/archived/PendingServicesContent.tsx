...
//           const updatedServices = campaign.campaign_services.map((service: any) => {
...
//             <AccordionItem key={campaign.campaign_id} value={`item-${campaign.campaign_id}`}>
//               <AccordionTrigger>
...
//               </AccordionTrigger>
//               <AccordionContent>
//               {Array.from(new Set(campaign.campaign_services.map(service => service.platform))).map(platform => {
//                   // Filter services by platform and group by influencers for that platform
//                   const platformServices = campaign.campaign_services.filter(service => service.platform === platform);
...
//                               )}
//                               onClick={() => isEditable && onStatusToggle(campaign.campaign_id, service.id)}>
